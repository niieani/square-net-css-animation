...
gulp.task('clean', () => del(['.dev', '.tmp', 'dist/*', '!dist/.git'], {dot: true}));

// Copy All Files At The Root Level (app)
gulp.task('copy-runtimes', () => {
  return gulp.src([
    'node_modules/babel/node_modules/babel-core/browser-polyfill.min.js'
  ], {
    dot: true
...
gulp.task('serve:dev', ['copy-runtimes', 'html:dev', 'babel', 'styles'], () => {
  ...
  gulp.watch(['app/scripts/**/*.js'], ['babel']); //'jshint', 
